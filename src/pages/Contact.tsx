  ...
  return (
    <div id="contact" className="min-h-screen w-full bg-white">
      <div className="p-8 pt-24 container mx-auto flex-col justify-center items-center max-w-6xl space-y-8 md:p-24">
        ...
        <div
          ref={ref}
          className="grid grid-cols-1 md:grid-cols-2 gap-16 space-y-3 md:space-y-0"
        >
          <div
            className={`flex flex-col  space-y-6 horizontal-fade-in ${isVisible ? "is-visible" : ""}`}
          ...
          <div
            className={`bg-white drop-shadow-xl p-6 horizontal-fade-in ${isVisible ? "is-visible" : ""}`}
            style={{ "--offset": "-10vh" } as CSSProperties}
          >
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <input
                    id="name"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-600 translate-[1.02] transition-transform duration-300"
                    name="name"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    id="email"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 placeholder-gray-400"
                    name="email"
              ...
              <div className="space-y-2 ">
                ...
                <input
                  id="subject"
                  className="w-full px-3 py-2 border border-gray-300 placeholder-gray-400 rounded-md focus:ring-2 focus:ring-purple-600 focus:outline-none"
                  name="subject"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  id="message"
                  rows={5}
                  className="px-3 py-2   w-full border border-gray-300 rounded-md focus:ring-2 focus:ring-purple-600 focus:outline-none placeholder-gray-400 "
                  name="message"
              ...
              <div className="space-y-2 flex items-center justify-center bg-purple-500 hover:bg-purple-400 text-white w-full py-2 rounded-md hover:cursor-pointer hover:scale-[1.03] translateZ[0px] transition transform   duration-500 ease-in-out">
                <button
                  className="w-full hover:cursor-pointer focus:outline-none"
                  type="submit"
                >
                  Submit Message
                </button>
