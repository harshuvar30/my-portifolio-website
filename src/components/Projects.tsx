    ...
    <div id="projects" className="w-full bg-white">
      <div className="relative container mx-auto max-w-6xl flex-col justify-center items-center p-24 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="inset-0  flex flex-col space-y-1.5 h-full items-center justify-center relative overflow-hidden  transition-all duration-700 ease-in-out hover:-translate-y-1">
            <div className="inset-0 w-full bg-none group transition transform  duration-500 ease-in-out">
              ...
              <div className="p-6 pt-0">
                ...
                <div className="flex flex-wrap gap-2 mt-4 text-sm font-semibold font-black">
                  <span className="rounded-2xl bg-purple-100 px-3 border-1 border-gray-300">
                    NextJs
                  </span>
                  <span className="rounded-2xl bg-purple-100 px-3 border-1 border-gray-300">
                    OpenAI API
                ...
                <div className="hover:scale-[1.02] transition-all duration-300 ease-in-out flex items-center justify-center border-1 h-10 rounded-md border-gray-300 mt-5 hover:bg-purple-200 ">
                  <svg
                    className="h-6 w-6 "
                    fill="#b1b6af"
                    width="64px"
          ...
          <div className="border-1 rounded-lg h-full br-gray-100 flex items-center justify-center">
            Project 2
          </div>
        </div>
      </div>
