...
import type { ProjectDetailsInterface } from "../interface/ProjectDetails";
...
export function ProjectCard({
  ...
  return (
    <div className="inset-0  flex flex-col space-y-1.5 h-full items-center justify-center relative overflow-hidden  transition-all duration-700 ease-in-out hover:-translate-y-1">
      <div
        className={`inset-0 w-full bg-none group transition transform  duration-500 ease-in-out fade-in-section ${isVisible ? "is-visible" : ""}`}
        style={{ "--offset": "10vh" } as CSSProperties}
      >
        <div ref={ref} className={`p-6 space-y-2 relative z-10 `}>
